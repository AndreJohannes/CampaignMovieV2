...
class Watering(Flicker.Flicker):
    def __init__(self):
        super().__init__()
        self.frame = 0
    ...
    def _get_image(self) -> Image.Image:
        return Image.open("./sequences/watering/image{:02d}.png".format(self.frame))

    def export(self):
        pickle.dump(self._export(), open("../StickmanScenes/data/watering.dat", "wb"))
