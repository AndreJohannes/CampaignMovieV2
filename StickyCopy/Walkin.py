...
class Walkin(Flicker.Flicker):
    ...
    def _get_image(self) -> Image.Image:
        return Image.open("./sequences/walkin/walkin-{}.png".format(self.frame))

    def save(self):
        pickle.dump(self.objects_for_frame, open("./data/walking.dat", "wb"))

    def load(self):
        self.objects_for_frame = pickle.load(open("./data/walking.dat", "rb"))
    ...
    def export(self):
        ...
        pickle.dump(export_list, open("../StickmanScenes/data/walking.dat", "wb"))
