...
class Wall(Flicker.Flicker):
    def __init__(self):
        super().__init__(self.key_callback)
        self.frame = 0
        self.objects = [Stickman(), Stickman()]
    ...
    def _get_image(self) -> Image.Image:
        return Image.open("./sequences/wall/frame{}.png".format(self.frame))

    def save(self):
        pickle.dump(self.objects_for_frame, open("./data/wall.dat", "wb"))

    def load(self):
        self.objects_for_frame = pickle.load(open("./data/wall.dat", "rb"))
    ...
    def export(self):
        ...
        pickle.dump(export_list, open("../StickmanScenes/data/wall.dat", "wb"))
